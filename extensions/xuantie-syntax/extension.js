...
const keywordSnippets = [
    ...
    { label: "布尔", desc: "布尔 (buer -> 布尔)", body: "布尔" },
    ...
    { label: "且", desc: "且 (qie -> 且,逻辑与)", body: "且" },
    { label: "或", desc: "或 (huo -> 或,逻辑或)", body: "或" },
    { label: "非", desc: "非 (fei -> 非,逻辑非)", body: "非" },
    { label: "是", desc: "是 (shi -> 是,相等/类型判断)", body: "是" },
    { label: "位与", desc: "位与 (wy -> 位与)", body: "位与" },
    { label: "位或", desc: "位或 (wh -> 位或)", body: "位或" },
    { label: "异或", desc: "异或 (yh -> 异或)", body: "异或" },
    { label: "左移", desc: "左移 (zy -> 左移)", body: "左移" },
    { label: "右移", desc: "右移 (yy -> 右移)", body: "右移" },
    { label: "取反", desc: "取反 (qf -> 取反,位运算前缀)", body: "取反" },
