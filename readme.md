...
[![版本](https://img.shields.io/badge/版本-0.15.7-red.svg)](https://gitee.com/mark-jy/xuantie)
...
玄铁由中国广东一名 17 岁开发者独立设计并实现。从 2026 年 4 月 3 日的 v0.2 起步，在半个月内已迭代至 v0.15.4，目前正处于**自举编译器 (Self-Hosted Compiler)** 的核心攻坚阶段。
